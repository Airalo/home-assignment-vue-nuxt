    ...
    <div class="container mx-auto">
      <div class="grid grid-cols-6 gap-7.5">
        <div class="">
          ...
          <p class="text-small mt-5 text-secondary">
            Airalo is the world’s first eSIM store that solves the pain of high roaming bills by giving you access to
            200+ eSIMs (digital SIM cards) globally at affordable prices.
          </p>
        </div>
        <div v-for="(col, index) in footerMenu" :key="`footer-col-${index}`">
          <p class="text-normal leading-normal font-medium">
            {{ col.title }}
          </p>
          <ul class="mt-2.5">
            <li v-for="(item, itemIndex) in col.links" :key="`footer-col-${index}-item-${itemIndex}`" class="mt-2.5">
